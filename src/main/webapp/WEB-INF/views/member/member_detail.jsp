            ...
            <div class="row">
                <div class="col-md-3 col-xs-12 col-sm-6 col-lg-3">
                  <div class="thumbnail text-center photo_view_postion_b" >
                    <img id="profileBtn" src="${paht.img}/2.jpg" alt="stack photo" class="img">
                  </div>
                </div>
                <div class="col-md-9 col-xs-12 col-sm-6 col-lg-9">
                    <div class="" style="border-bottom:1px solid black">
                      ...
                      <hr>
                    <div class="col-md-6"> 
                    <input type="hidden" id="id" value="${requestScope.student.id}" /> 
                    <ul class=" details"> 
                      <li>
                      	<p>
                      ...
                      <li><p id="ssn"><span class="glyphicon glyphicon-bold" style="width:50px;"></span>
